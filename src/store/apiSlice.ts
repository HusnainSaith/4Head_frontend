...
export const apiSlice = createApi({
  ...
  tagTypes: [
    "Party", "PartyStatement", "BrokeragePurchase", "BrokerageSale",
    "BrokerageStock", "BrokerageReport", "BrokerageStockMovement",
    "WastagePurchase", "WastageSale", "WastageStock", "WastageReport",
    "SupplyPurchase", "SupplySale", "SupplyStock", "SupplyReport",
    "InternalTransfer", "FreshChickenStock",
    "Vehicle", "VehicleFuelLog", "VehicleMaintenanceLog", "Expense",
    "Employee", "EmployeeAdvance", "EmployeeBonus", "SalaryRun",
    "ShopSale", "ShopReport",
    "User",
  ],
  endpoints: () => ({}),
